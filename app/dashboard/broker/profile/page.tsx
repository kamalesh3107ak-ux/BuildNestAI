      ...
      >
        <div className="flex justify-between items-start mb-8">
          <div>
            ...
            <p className="text-muted-foreground">Manage your broker information</p>
          </div>
          {!editing && (
            <Button
        ...
        <Card className="glass p-8 space-y-6">
          ...
          <div>
            <label className="block text-sm text-muted-foreground mb-2">Agency Name</label>
            {editing ? (
              <Input
              ...
              <p className="font-medium">{profile?.agency_name || 'Not set'}</p>
            )}
          </div>
